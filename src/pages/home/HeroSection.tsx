...
const HeroSection = () => {
  return (
    <Container className="h-[calc(100vh-64px)] grid grid-cols-1 lg:grid-cols-2 place-items-center bg-green-500">
      <div>
      ...
      <div className="mt-10 w-4/5 lg:w-full mx-auto">
        <img className="-rotate-[35deg] h-[95%] object-contain" src={macbook} alt="macbook exposed" />
      </div>
    </Container>
  );
};
